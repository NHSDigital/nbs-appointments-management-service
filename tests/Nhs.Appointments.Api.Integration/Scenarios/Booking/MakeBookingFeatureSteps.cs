...
namespace Nhs.Appointments.Api.Integration.Scenarios.Booking
{
    ...
    public abstract class MakeBookingFeatureSteps(string flag, bool enabled) : BookingBaseFeatureSteps(flag, enabled)
    {
    ...
    public class MakeBookingFeatureSteps_MultipleServicesEnabled()
        : MakeBookingFeatureSteps(Flags.MultipleServices, true);

    [Collection("MultipleServicesSerialToggle")]
    public class MakeBookingFeatureSteps_MultipleServicesDisabled()
        : MakeBookingFeatureSteps(Flags.MultipleServices, false);
}
