...
//                   createAvailabilityPage.clickCreateAvailabilityButton(),
//                 )
//                 .then(async createAvailabilityWizard => {
//                   await expect(
//                     createAvailabilityWizard.singleOrRepeatingSessionStep.title,
//                   ).toBeVisible();
//                   await createAvailabilityWizard.singleOrRepeatingSessionStep.singleSessionRadio.check();
//                   await createAvailabilityWizard.singleOrRepeatingSessionStep.continueButton.click();

//                   await expect(
//                     createAvailabilityWizard.startAndEndDateStep
//                       .singleSessionTitle,
//                   ).toBeVisible();
//                   await createAvailabilityWizard.startAndEndDateStep.singleSessionDateDayInput.fill(
//                     `${tomorrow.day}`,
//                   );
//                   await createAvailabilityWizard.startAndEndDateStep.singleSessionDateMonthInput.fill(
//                     `${tomorrow.month}`,
//                   );
//                   await createAvailabilityWizard.startAndEndDateStep.singleSessionDateYearInput.fill(
//                     `${tomorrow.year}`,
//                   );
//                   await createAvailabilityWizard.startAndEndDateStep.continueButton.click();

//                   await expect(
//                     createAvailabilityWizard.timeAndCapacityStep.title,
//                   ).toBeVisible();
//                   await createAvailabilityWizard.timeAndCapacityStep.startTimeHourInput.fill(
//                     '09',
//                   );
//                   await createAvailabilityWizard.timeAndCapacityStep.startTimeMinuteInput.fill(
//                     '00',
//                   );
//                   await createAvailabilityWizard.timeAndCapacityStep.endTimeHourInput.fill(
//                     '10',
//                   );
//                   await createAvailabilityWizard.timeAndCapacityStep.endTimeMinuteInput.fill(
//                     '00',
//                   );
//                   await createAvailabilityWizard.timeAndCapacityStep.capacityInput.fill(
//                     '2',
//                   );
//                   await createAvailabilityWizard.timeAndCapacityStep.appointmentLengthInput.fill(
//                     '6',
//                   );
//                   await createAvailabilityWizard.timeAndCapacityStep.continueButton.click();

//                   await expect(
//                     createAvailabilityWizard.selectServicesStep.title,
//                   ).toBeVisible();
//                   await createAvailabilityWizard.selectServicesStep.rsvCheckbox.check();
//                   await createAvailabilityWizard.selectServicesStep.continueButton.click();

//                   await expect(
//                     createAvailabilityWizard.summaryStep.title,
//                   ).toBeVisible();

//                   await expect(
//                     createAvailabilityWizard.summaryStep.datesSummary.getByText(
//                       `${tomorrow.day} ${tomorrow.month}`,
//                       { exact: true },
//                     ),
//                   ).toBeVisible();
//                   await expect(
//                     createAvailabilityWizard.summaryStep.timeSummary.getByText(
//                       `09:00 - 10:00`,
//                       {
//                         exact: true,
//                       },
...
//                   ).toBeVisible();
//                   await expect(
//                     createAvailabilityWizard.summaryStep.capacitySummary.getByText(
//                       `2`,
//                       {
//                         exact: true,
//                       },
...
//                   ).toBeVisible();
//                   await expect(
//                     createAvailabilityWizard.summaryStep.appointmentLengthSummary.getByText(
//                       `6 minutes`,
//                       {
//                         exact: true,
//                       },
...
//                   ).toBeVisible();
//                   await expect(
//                     createAvailabilityWizard.summaryStep.servicesSummary.getByText(
//                       `RSV (Adult)`,
//                       {
//                         exact: true,
//                       },
...
//                   return createAvailabilityWizard.summaryStep.saveSession();
//                 })
