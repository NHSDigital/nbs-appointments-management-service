Feature: Set availability
  ...
  Scenario: Appointment status recalculation does not affect cancelled or provisional bookings
    ...
    And the booking at the default site with reference '10293-45957' has availability status 'Unknown'
    And the booking at the default site with reference '48232-10293' has status 'Provisional'
    And the booking at the default site with reference '48232-10293' has availability status 'Supported'
  ...
  Scenario: Provisional bookings that are unsupported are deleted from the DB
    ...
    And the booking at the default site with reference '84583-19232' has availability status 'Supported'
    And the booking at the default site with reference '90386-19232' has status 'Booked'
    And the booking at the default site with reference '90386-19232' has availability status 'Supported'
    And the booking at the default site with reference '92225-30492' should be deleted
...
#  Bug found and raised for disabled code path - APPT-906  
  Scenario: Expired provisional bookings are not considered live and can allow orphaned appointments to take their place
    ...
    And the booking at the default site with reference '65734-19232' has availability status 'Supported'
#    The expired provisional stays in the DB, and will be cleaned up by the cleanup process
    And the booking at the default site with reference '92363-30492' has status 'Provisional'
    And the booking at the default site with reference '92363-30492' has availability status 'Supported'
    And the booking at the default site with reference '61865-10293' has status 'Booked'
  ...
  Scenario: Bookings are prioritised by created date
    ...
    And the booking at the default site with reference '34482-10293' has availability status 'Orphaned'
    And the booking at the default site with reference '45853-10293' has status 'Booked'
  ...
  Scenario: Provisional bookings are still considered live but don't prevent confirmed orphaned appointments taking their place
    ...
    And the booking at the default site with reference '56923-19232' has availability status 'Supported'
    And the booking at the default site with reference '19283-30492' should be deleted
  ...
  Scenario: Provisional bookings are still considered live but get allocated after booked appointments, despite being created earlier
    ...
    Then the booking at the default site with reference '56923-19232' has status 'Booked'
    And the booking at the default site with reference '56923-19232' has availability status 'Supported'
    And the booking at the default site with reference '19283-30492' has status 'Provisional'
  ...
  Scenario: Provisional bookings are allocated first when confirmed first
    ...
    And the booking at the default site with reference '19283-30483' has availability status 'Supported'
    ...
    And the booking at the default site with reference '19283-30483' has availability status 'Supported'
    And the booking at the default site with reference '03283-30492' should be deleted
  ...
  Scenario: Provisional bookings are allocated first when confirmed second
    ...
    And the booking at the default site with reference '03283-30492' has availability status 'Supported'
    And the booking at the default site with reference '19283-30483' should be deleted
  ...
  Scenario: Provisional bookings are allocated by created date when both confirmed
    ...
    And the booking at the default site with reference '19283-30483' has availability status 'Supported'
    Then the booking at the default site with reference '03283-30492' has status 'Booked'
    And the booking at the default site with reference '03283-30492' has availability status 'Orphaned'
