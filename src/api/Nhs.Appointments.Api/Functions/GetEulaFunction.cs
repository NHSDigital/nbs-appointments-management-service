...
namespace Nhs.Appointments.Api.Functions
{
    ...
    : BaseApiFunction<EmptyRequest, EulaVersion>(validator, userContextProvider, logger, metricsRecorder)
    {
        ...
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, "application/json", typeof(EulaVersion), Description = "The latest version of the End-User Licence Agreement")]
        [Function("GetEulaFunction")]
        public override Task<IActionResult> RunAsync(
          [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "eula")] HttpRequest req)
        {
