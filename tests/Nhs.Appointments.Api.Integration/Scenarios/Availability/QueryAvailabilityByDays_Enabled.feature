Feature: Query Availability By Days
  ...
  Scenario: Only returns matching days for a single attendee at a single site with a single service
    ...
    Scenario: 'Neighbouring' slot logic is not ideal if slot lengths do not easily divide across services - no results
      ...
      When I query availability by days at the default site
        | Attendee Services      | From     | Until    |
        | RSV:Adult,COVID:5_11   | Tomorrow | Tomorrow |
  ...
  Scenario: Only returns matching days for rwo Attendees with two Services at a single Site
    ...
    When I query availability by days at the default site
      | Attendee Services             | From     | Until             |
      | RSV:Adult,COVID:5_11          | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
      | 2 days from today | PM     | 12:00 | 17:00 |
  ...
  Scenario: Only returns matching days for two attendees with a single service at a single Site
    ...
    When I query availability by days at the default site
      | Attendee Services            | From     | Until             |
      | RSV:Adult,RSV:Adult | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
      | Tomorrow          | AM,PM  | 09:00 | 17:00 |
      | 2 days from today | PM     | 12:00 | 17:00 |
  ...
  Scenario: Only return matching slots for three attendees requesting three services at a single site
    ...
    When I query availability by days at the default site
      | Attendee Services                       | From     | Until             |
      | RSV:Adult,COVID:5_11,FLU:18_64 | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
  ...
  Scenario: Only return matching days for three attendees requesting two services at a single site
    ...
    When I query availability by days at the default site
      | Attendee Services                       | From     | Until             |
      | RSV:Adult,COVID:5_11,RSV:Adult | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
      | 2 days from today | AM,PM  | 09:00 | 17:00 |
  ...
  Scenario: Only return matching days for three attendees requesting a single service at a single site
    ...
    When I query availability by days at the default site
      | Attendee Services                      | From     | Until             |
      | RSV:Adult,RSV:Adult,RSV:Adult          | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
      | 2 days from today | AM,PM  | 09:00 | 17:00 |
  ...
  Scenario: Return matching days for a single attendee at multiple sites
    ...
    And the following sessions exist for existing site 'aa0ffcae-89dd-4017-8eda-c5c0dbdcbe07'
      | Date              | From  | Until | Services  | Slot Length | Capacity |
      | Tomorrow          | 09:00 | 17:00 | RSV:Adult | 10          | 1        |
    And the following sessions exist for existing site '0a377442-1be4-413c-ac36-a2583864704b'
      | Date              | From  | Until | Services  | Slot Length | Capacity |
      | 2 days from today | 12:00 | 17:00 | RSV:Adult | 10          | 1        |
  ...
  Scenario: Return matching days for two attendees at multiple sites for a single service
    ...
    And the following sessions exist for existing site '252b0be3-cb39-443e-95a9-06ac37c63346'
      | Date              | From  | Until | Services  | Slot Length | Capacity |
      | Tomorrow          | 09:00 | 17:00 | RSV:Adult | 10          | 1        |
    And the following sessions exist for existing site 'b17d91f0-4332-4e66-83a9-2978b7e36456'
      | Date              | From  | Until | Services  | Slot Length | Capacity |
      | 2 days from today | 12:00 | 17:00 | RSV:Adult | 10          | 1        |
    When I query availability by days for multiple sites
      | Sites                                                                      | Attendee Services             | From     | Until             |
  ...
  Scenario: Return matching days for two attendees at multiple sits for multiple services
    ...
    And the following sessions exist for existing site '41708fe0-6c89-46a4-8183-1a8d0f919cc2'
      | Date              | From  | Until | Services  | Slot Length | Capacity |
      | Tomorrow          | 09:00 | 17:00 | RSV:Adult | 10          | 1        |
    And the following sessions exist for existing site '1ac0fd0e-c421-4633-bc23-95dc92003803'
      | Date              | From  | Until | Services   | Slot Length | Capacity |
      | 2 days from today | 12:00 | 17:00 | COVID:5_11 | 10          | 1        |
      | 2 days from today | 12:00 | 17:00 | RSV:Adult  | 10          | 1        |
    When I query availability by days for multiple sites
  ...
  Scenario: Returns empty days array when there are no matching slots
    ...
    When I query availability by days at the default site
      | Attendee Services    | From     | Until             |
      | COVID:5_11           | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
  ...
  Scenario: Returns empty days array when there are no matching slots for multiple attendees requesting multiple services even though one service matches
    ...
    When I query availability by days at the default site
      | Attendee Services    | From     | Until             |
      | RSV:Adult,FLU:2_3    | Tomorrow | 2 days from today |
    Then the following availability by days is returned at the default site
      | Date              | Blocks | From  | Until |
  ...
  Scenario: Not enough availability for the amount of attendees required
    ...
    When I query availability by days at the default site
      | Attendee Services                                  | From     | Until    |
      | RSV:Adult,RSV:Adult,RSV:Adult,RSV:Adult,RSV:Adult  | Tomorrow | Tomorrow |
  ...
  Scenario: Just enough availability for the amount of attendees required
    ...
    When I query availability by days at the default site
      | Attendee Services                       | From     | Until    |
      | RSV:Adult,RSV:Adult,RSV:Adult,RSV:Adult | Tomorrow | Tomorrow |
  ...
  Scenario: Returns bad request when too many attendees are passed up
    ...
    When I query availability by days at the default site
      | Attendee Services                                           | From     | Until    |
      | RSV:Adult,RSV:Adult,RSV:Adult,RSV:Adult,RSV:Adult,RSV:Adult | Tomorrow | Tomorrow |
    Then the call should fail with 400
  ...
  Scenario: Greedy allocation by service length - optimal and suboptimal combinations
    ...
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:64_80, FLU:5_11   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
    ...
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:2_3, FLU:5_11     | Tomorrow | Tomorrow |
    Then the response should be empty
    # -- END SUBOPTIMAL
    # OPTIMAL
    ...
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | COVID, FLU:5_11       | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:11_18, FLU:5_11   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:18:40, FLU:5_11   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:64_80, RSV:Adult   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | COVID, RSV:Adult       | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:11_18, RSV:Adult   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:18:40, RSV:Adult   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:64_80, COVID   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | COVID, COVID       | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:11_18, COVID   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:18:40, COVID   | Tomorrow | Tomorrow |
    Then the following availability by days is returned at the default site
      | Date     | Blocks | From  | Until |
      | Tomorrow | AM     | 09:00 | 09:30 |
    # -- END OPTIMAL
    ...
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:2_3, COVID        | Tomorrow | Tomorrow |
    Then the response should be empty
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:2_3, RSV:Adult    | Tomorrow | Tomorrow |
    Then the response should be empty
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:2_3, FLU:64_80    | Tomorrow | Tomorrow |
    Then the response should be empty
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:2_3, FLU:11_18    | Tomorrow | Tomorrow |
    Then the response should be empty
    When I query availability by days at the default site
      | Attendee Services     | From     | Until    |
      | FLU:2_3, FLU:18:40    | Tomorrow | Tomorrow |
    Then the response should be empty
    # -- END SUBOPTIMAL
