        ...
        logger, metricsRecorder)
{
    ...
    [OpenApiParameter("from", In = ParameterLocation.Query, Required = true, Type = typeof(double),
        Description = "The start of the date range to get daily availability")]
    [OpenApiParameter("to", In = ParameterLocation.Query, Required = true, Type = typeof(double),
        Description = "The end of the date range to get daily availability")]
    [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, "application/json", typeof(IEnumerable<DailyAvailability>),
        Description = "List of daily availability within a date range")]
    ...
    protected override Task<(IReadOnlyCollection<ErrorMessageResponseItem> errors, GetDailyAvailabilityRequest request)>
        ReadRequestAsync(HttpRequest req)
    {
        ...
        return Task
            .FromResult<(IReadOnlyCollection<ErrorMessageResponseItem> errors, GetDailyAvailabilityRequest request)>
