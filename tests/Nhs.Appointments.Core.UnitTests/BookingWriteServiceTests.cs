...
namespace Nhs.Appointments.Core.UnitTests
{
    public class BookingWriteServiceTests
    {
        ...
        public async Task MakeBooking_AcquiresLock_WhenBooking()
        {
            ...
            _referenceNumberProviderV1.Setup(x => x.GetReferenceNumber(It.IsAny<string>())).ReturnsAsync("TEST1");
            _referenceNumberProviderV2.Setup(x => x.GetReferenceNumber()).ReturnsAsync("TEST1");
        ...
        public async Task RescheduleBooking_IsSuccessful()
        {
            ...
            _referenceNumberProviderV1.Setup(x => x.GetReferenceNumber(It.IsAny<string>())).ReturnsAsync("TEST1");
            _referenceNumberProviderV2.Setup(x => x.GetReferenceNumber()).ReturnsAsync("TEST2");
        ...
        public async Task RecalculateAppointmentStatuses_ReturnsBookingsCanceledWithoutDetails()
        {
            ...
            _bookingAvailabilityStateService
                ...
                {
                    new(bookings[0], AvailabilityUpdateAction.SetToOrphaned),
            ...
            _bookingAvailabilityStateService
                ...
                .ReturnsAsync(new List<BookingAvailabilityUpdate>
                {
                    new(bookings[2], AvailabilityUpdateAction.SetToOrphaned),
