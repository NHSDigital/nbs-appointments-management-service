...
public static class FeatureToggleCollectionNames
{
    ...
    public const string AllMultipleCollection = $"{Flags.SiteStatus}|{Flags.CancelDay}|{Flags.ChangeSessionUpliftedJourney}|{Flags.CancelSessionUpliftedJourney}|{Flags.QuerySites}|{Flags.MultiServiceJointBookings}|{Flags.ReportsUplift}_Toggle";
...
[CollectionDefinition(FeatureToggleCollectionNames.AllMultipleCollection)]
public class AllMultipleCollection : ICollectionFixture<object>
{
}
