...
resource "azurerm_cdn_frontdoor_rule" "nbs_mya_origin_group_bulk_import_site_override_rule" {
  count = var.create_frontdoor ? 1 : 0
  depends_on = [
    azurerm_cdn_frontdoor_origin_group.nbs_mya_http_function_app_origin_group,
    azurerm_cdn_frontdoor_origin.nbs_mya_http_function_app_origin,
  ...
  name                      = "BulkImportSiteRouteOverride"
  cdn_frontdoor_rule_set_id = azurerm_cdn_frontdoor_rule_set.nbs_mya_origin_group_override_rule_set[0].id
  order                     = 1
  behavior_on_match         = "Continue"
  ...
  conditions {
    url_path_condition {
      operator         = "EndsWith"
      negate_condition = false
      match_values     = ["/site/import"]
      transforms       = ["Lowercase"]
    }
  }
}

resource "azurerm_cdn_frontdoor_rule" "nbs_mya_origin_group_bulk_import_user_override_rule" {
  count = var.create_frontdoor ? 1 : 0
  depends_on = [
    azurerm_cdn_frontdoor_origin_group.nbs_mya_http_function_app_origin_group,
    azurerm_cdn_frontdoor_origin.nbs_mya_http_function_app_origin,
  ...
  name                      = "BulkImportUserRouteOverride"
  cdn_frontdoor_rule_set_id = azurerm_cdn_frontdoor_rule_set.nbs_mya_origin_group_override_rule_set[0].id
  order                     = 1
  behavior_on_match         = "Continue"
