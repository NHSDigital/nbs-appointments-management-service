...
resource "azurerm_windows_function_app_slot" "nbs_mya_func_app_preview" {
  ...
  app_settings = {
    ...
    AzureWebJobs_NotifyUserRolesChanged_Disabled               = true
    AzureWebJobs_NotifyBookingMade_Disabled                    = true
    AzureWebJobs_NotifyBookingRescheduled_Disabled             = true
    AzureWebJobs_NotifyBookingCancelled_Disabled               = true
    AzureWebJobs_SendBookingReminders_Disabled                 = true
    AzureWebJobs_NotifyBookingReminder_Disabled                = true
    AzureWebJobs_RemoveUnconfirmedProvisionalBookings_Disabled = true
    GovNotifyBaseUri                                           = var.gov_notify_base_uri
    GovNotifyApiKey                                            = var.gov_notify_api_key
    BookingRemindersCronSchedule                               = var.booking_reminders_cron_schedule
    UnconfirmedProvisionalBookingsCronSchedule                 = var.unconfirmed_provisional_bookings_cron_schedule
