        ...
        metricsRecorder)
{
    ...
    [OpenApiResponseWithoutBody(statusCode: HttpStatusCode.OK,
        Description = "Site informationForCitizens value successfully saved")]
    ...
    protected override async
        Task<(IReadOnlyCollection<ErrorMessageResponseItem> errors, SetSiteInformationForCitizensRequest request)>
