...
public interface IAvailabilityWriteService
{
    ...
    Task<(bool editSuccessful, string message)> EditSessionAsync(string site, DateOnly from, DateOnly until, Session? sessionMatcher, Session? sessionReplacement, bool isWildcard);
}
