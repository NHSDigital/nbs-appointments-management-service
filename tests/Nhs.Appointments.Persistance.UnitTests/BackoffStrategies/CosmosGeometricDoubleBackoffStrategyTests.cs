...
public class CosmosGeometricDoubleBackoffStrategyTests
{
    ...
    [Fact]
    public void SutIsCreated_BackoffIsCalledMultipleTimes_NextRetryDelayMsShouldBeInitialValueFromRetryConfigurationDoubledTheNumberOfRetryCount()
    {
        // Arrange.
        var randomInitialValueMs = Random.Next(1000, 5000);
