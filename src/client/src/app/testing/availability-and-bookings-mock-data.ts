    ...
    sessions: [
      {
        ...
        totalSupportedAppointmentsByService: { 'RSV:Adult': 2 },
        capacity: 2,
        slotLength: 5,
      },
      {
        ...
        totalSupportedAppointmentsByService: { 'RSV:Adult': 0 },
        capacity: 1,
        slotLength: 5,
      },
    ],
    ...
    sessions: [
      {
        ...
        maximumCapacity: 36,
        totalSupportedAppointments: 2,
        totalSupportedAppointmentsByService: { 'RSV:Adult': 1, 'FLU:18_64': 1 },
        capacity: 2,
        slotLength: 10,
      },
      {
    ...
    sessions: [
      {
        ...
        maximumCapacity: 96,
        totalSupportedAppointments: 0,
        totalSupportedAppointmentsByService: { 'RSV:Adult': 0, 'FLU:18_64': 0 },
        capacity: 4,
        slotLength: 10,
      },
    ],
  ...
  },
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        maximumCapacity: 18,
        totalSupportedAppointments: 0,
        totalSupportedAppointmentsByService: { 'FLU:18_64': 0 },
        capacity: 1,
        slotLength: 10,
      },
    ],
