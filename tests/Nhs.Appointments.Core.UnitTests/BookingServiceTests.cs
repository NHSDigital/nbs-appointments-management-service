...
namespace Nhs.Appointments.Core.UnitTests
{
    public class BookingServiceTests
    {
        ...
        public async Task MakeBooking_ReturnsSuccess_WhenSlotIsAvailable()
        {
            ...
            var booking = new Booking { Site = "TEST", Service = "TSERV", From = new DateTime(2077, 1, 1, 10, 0, 0, 0), Duration = 10, ContactDetails = new ContactDetails(), AttendeeDetails = new AttendeeDetails()  };
