Feature: Manage site attributes
  ...
  Scenario: Add attribute to a site
    ...
    Then the correct information for site 'A' is returned
      | Site | Name   | Address     | Attributes                                                           | Longitude | Latitude |
      | A    | Site-A | 1A New Lane | def_one/attr_one=true, def_one/attr_two=false, def_two/attr_one=true | -60       | -60      |
  ...
  Scenario: Switch off attributes for a site
    ...
    Then the correct information for site 'B' is returned
      | Site | Name   | Address      | Attributes                                                             | Longitude | Latitude |
      | B    | Site-B | 1B Park Lane | def_one/attr_one=false, def_one/attr_two=false, def_two/attr_one=false | -60       | -60      |
