...
) : IBookingsDocumentStore
{
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetBookingsInDateRange))
        {
    ...
    public async Task<IEnumerable<Booking>> QueryByFilterAsync(BookingQueryFilter queryFilter)
    {
        ...
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetBookingsByFilter))
        {
    ...
    public async Task<IEnumerable<Booking>> GetCrossSiteAsync(DateTime from, DateTime to, params AppointmentStatus[] statuses)
    {
        ...
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetCrossSiteBookings))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetBookingByReference))
        {
            try
            {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetBookingsByNhsNumber))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.UpdateBookingStatus))
        {
            var bookingIndexDocument = await indexStore.GetDocument<BookingIndexDocument>(bookingReference);
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.UpdateBookingAvailabilityStatus))
        {
            var bookingIndexDocument = await indexStore.GetDocument<BookingIndexDocument>(bookingReference);
            if (bookingIndexDocument == null)
            {
    ...
    public async Task<BookingConfirmationResult> ConfirmProvisionals(string[] bookingReferences, IEnumerable<ContactItem> contactDetails)
    {
        ...
        using (metricsRecorder.BeginScope(MetricScopes.Booking.ConfirmProvisionalBookings))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.ConfirmProvisionalBooking))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.SetReminderSent))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.InsertBooking))
        {
    ...
    public async Task<IEnumerable<string>> RemoveUnconfirmedProvisionalBookings()
    {
        ...
        using (metricsRecorder.BeginScope(MetricScopes.Booking.RemoveUnconfirmedProvisionalBookings))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.DeleteBooking))
        {
            await Task.WhenAll(
    ...
    public async Task<(int cancelledBookingsCount, int bookingsWithoutContactDetailsCount, List<Booking> bookingsWithContactDetails)> CancelAllBookingsInDay(string site, DateOnly date)
    {
        ...
        using (metricsRecorder.BeginScope(MetricScopes.Booking.CancelAllBookingsInADay))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.CancellationNotified))
        {
    ...
    public async Task<IEnumerable<Booking>> GetRecentlyUpdatedBookingsCrossSiteAsync(DateTime from, DateTime to, params AppointmentStatus[] statuses)
    {
        ...
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetRecentlyUpdatedBookingsCrossSite))
        {
    ...
    {
        using (metricsRecorder.BeginScope(MetricScopes.Booking.GetBookingsInStatusUpdatedDateRange))
        {
