...
public interface IAvailabilityWriteService
{
    ...
    Task<SessionModificationResult> EditOrCancelSessionAsync(string site, DateOnly from, DateOnly until, Session? sessionMatcher, Session? sessionReplacement, bool cancelNewlyOrphanedBookings);
}
