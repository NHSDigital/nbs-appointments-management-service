Feature: Manage site details
  ...
  Scenario: Update details of a site with an valid phone number with spaces
    ...
    Then the correct information for site 'beeae4e0-dd4a-4e3a-8f4d-738f9418fb51' is returned
      | Site                                 | Name   | Address     | PhoneNumber  | OdsCode | Region | ICB  | Attributes                                                            | Longitude | Latitude |
      | beeae4e0-dd4a-4e3a-8f4d-738f9418fb51 | Site-B | 2B New Lane | 0113 2222222 | 15N     | R1     | ICB1 | def_one/attr_one=true, def_one/attr_two=false, def_two/attr_one=true  | -50       | 33      |
